...
def init_db():
    ...
    with Session(engine) as session:
        ...
        if (
            ...
            enterprise = crud_subscription_plan.create(
                db=session,
                obj_in=SubscriptionPlanCreate(
                    plan_title="enterprise",
                    plan_price=175.0,
                    available_model="GPT-4 LLM",
                    message_credits=60000,
                    number_of_chatbots=5,
                    max_character_per_chatbot=20000000,
                    live_agent_takeover=True,
                    remove_label=False,
                    is_active=True,
                    created_at=datetime.now(),
            ...
            if not user_found:
                user_admin_default = crud_user.create(
                    ...
                    obj_in=UserInDB(
                        ...
                        display_name="admin",
                        avatar_url="https://frontend-assistain-ai-chatbot.vercel.app/Ellipse%201.svg",
